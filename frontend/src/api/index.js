...
export const profiles = {
  ...
  connectWhatsapp: (id) => api.post(`/profiles/${id}/whatsapp/connect`),
  getQR: (id) => api.get(`/profiles/${id}/whatsapp/qr`),
  getWaStatus: (id) => api.get(`/profiles/${id}/whatsapp/status`),
  logoutWhatsapp: (id) => api.post(`/profiles/${id}/whatsapp/logout`),
